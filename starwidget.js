...
const HEART_PATH =
  "M98.7,50c0,26.9-21.8,48.7-48.7,48.7S1.3,76.9,1.3,50S23.1,1.3,50,1.3S98.7,23.1,98.7,50z";

// ── SVG Shape Constants (extracted so buildWidgetTemplate stays clean) ───────

const STAR_PATHS = {
  s1: "M98.7,50c0,26.9-21.8,48.7-48.7,48.7S1.3,76.9,1.3,50S23.1,1.3,50,1.3S98.7,23.1,98.7,50z",
